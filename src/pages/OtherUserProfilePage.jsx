    ...
    <section className="w-80 hidden lg:block  h-max px-3 py-5 m-2 border border-gray-200 rounded-lg  overflow-hidden shadow-lg">
      ...
      <div className="flex mx-auto text-gray-600 justify-center items-center">
        <img
          ...
          src="https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fHByb2ZpbGUlMjBwaWN0dXJlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60"
          alt=""
        />
      </div>
      <div className="flex justify-center items-center text-cyan-700  font-semibold text-2xl pt-3">
        <h4>Aurelie Daniell</h4>
      </div>
