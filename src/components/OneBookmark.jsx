                ...
                {({ active }) => (
                  ...
                  >
                    {option.toLowerCase() === "delete" ? (
                      <TrashIcon className="h-5 w-5 flex float-left mr-3 stroke-1 stroke-indigo-800" />
                    ) : null}
                    {option.toLowerCase() === "mark as read" ? (
                      <CheckIcon className="h-5 w-5 flex float-left mr-3 stroke-1 stroke-indigo-800" />
                    ) : null}
                    {option.toLowerCase() === "turn off" ? (
                      <StatusOfflineIcon className="h-5 w-5 flex float-left mr-3 stroke-1 stroke-indigo-800" />
                    ) : null}
