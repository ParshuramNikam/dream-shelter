                ...
                <div className="flex flex-col h-full justify-center ">
                                ...
                                {({ userFname, setUserFname }) => (
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setInputAnswers({ ...inputAnswers, fname: e.target.value });
                                        }}
                                    />
                                )}
                            </UserFnameContext.Consumer>
                    ...
                    <div className="relative bottom-3 right-3">
                        <div className="flex justify-center items-center w-max">
                            ...
                            <button className={`${inputAnswers.fname === "" ? 'bg-neutral-300 cursor-not-allowed' : null} p-2 m-2 bg-gray-400 rounded-full`}
                                onClick={nextBtnClickListner} disabled={inputAnswers.fname === ""}
                            >
                ...
                <div className="flex flex-col h-full justify-center ">
                    ...
                    <div className="relative bottom-3 right-3">
                        <div className="flex justify-center items-center w-max">
                            ...
                            <button className={`${inputAnswers.lname === "" ? 'bg-neutral-300 cursor-not-allowed' : null} p-2 m-2 bg-gray-400 rounded-full`}
                                onClick={nextBtnClickListner} disabled={inputAnswers.lname === ""}
                            >
                                <ArrowRightIcon className='h-5 w-5 stroke stroke-gray-800' />
                            </button>
                        </div>
                ...
                <div className="flex flex-col h-full justify-center ">
                    <div className="mb-10">
                        ...
                        <div className="mx-3 my-5">
                            <input
                                ...
                                onChange={(e) => {
                                    setInputAnswers({ ...inputAnswers, location: e.target.value });
                                }}
                            />
                        </div>
                    </div>
                    <div className="relative bottom-3 right-3">
                        <div className="flex justify-center items-center w-max">
                            ...
                            <button className={`${inputAnswers.location === "" ? 'bg-neutral-300 cursor-not-allowed' : null} p-2 m-2 bg-gray-400 rounded-full`}
                                onClick={nextBtnClickListner} disabled={inputAnswers.location === ""}
                            >
                                <ArrowRightIcon className='h-5 w-5 stroke stroke-gray-800' />
                            </button>
                        </div>
            ...
            {currentIndex === 5 ? (
                <div className="flex flex-col h-full justify-center ">
                    ...
                    <div className="flex">
                        ...
                        <button className={`${cb1.length === 0 ? 'bg-neutral-300 cursor-not-allowed' : null} p-2 m-2 bg-gray-400 rounded-full`}
                            onClick={nextBtnClickListner}
            ...
            {currentIndex === 6 ? (
                <div className="flex flex-col h-full justify-center ">
                    ...
                    <div className="flex">
                        ...
                        <button className={`${cb2.length === 0 ? 'bg-neutral-300 cursor-not-allowed' : null} p-2 m-2 bg-gray-400 rounded-full`}
                            onClick={nextBtnClickListner}
