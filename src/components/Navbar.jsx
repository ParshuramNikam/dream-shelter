          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-between sm:items-stretch sm:justify-start">
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className={` ${
                      hidden ? "hidden" : ""
                    } bg-gray-200 p-1 rounded-sm text-gray-800  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white block md:hidden ml-2 `}
                    onClick={showSearchBox}
                  >
                    <span className="sr-only">Search-Bar</span>
                    <SearchIcon
                ...
                <div
                  class={`hidden md:block pt-2 relative mx-auto text-gray-600`}
                >
                  <input
                    ...
                    onBlur={
                      hideSearchBox
                    } /* event pccurs when focus gets out of input box */
                  />
                  <button
                    type="submit"
              ...
              <div
                className={`${
                  hidden ? "hidden" : ""
                } absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-2 sm:pr-0`}
              >
                <Link to={"/"}>
                  <button
                    type="button"
