...
import { ChatBoxPopOver } from "./ChatBoxPopOver";
...
function ChatBox() {
  ...
  return (
    <section className=" sticky top-2 w-72 hidden lg:block  h-max  px-1 py-2 m-2 bg-white border border-gray-200 rounded-lg overflow-hidden shadow-lg">
      ...
      <div className="pt-2 relative mx-auto text-gray-600">
        <input
          className="border-2 border-gray-300 bg-gray-50 mb-3 h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
          type="search"
          name="search"
          placeholder="Search"
        />
      ...
      <div className="overflow-y-auto max-h-96">
        ...
        >
          ...
          <div className="pl-3">
            ...
            <p className="text-xs leading-3 pt-1 text-gray-500">Send a post</p>
          </div>
        </div>
        <div
          className="w-60 p-1 m-2  rounded flex justify-start cursor-pointer"
        ...
        >
          ...
          <div className="pl-3">
            ...
            <p className="text-xs leading-3 pt-1 text-gray-500">Active now</p>
          </div>
        </div>
        <div
          className="w-60 p-1 m-2  rounded flex justify-start cursor-pointer"
        ...
        >
          ...
          <div className="pl-3">
            ...
            <p className="text-xs leading-3 pt-1 text-gray-500">Tim: Okay</p>
          </div>
        </div>
        <div
          className="w-60 p-1 m-2  rounded flex justify-start cursor-pointer"
        ...
        >
          ...
          <div className="pl-3">
            ...
            <p className="text-xs leading-3 pt-1 text-gray-500">Richard: Hii</p>
          </div>
        </div>
        <div
          className="w-60 p-1 m-2  rounded flex justify-start cursor-pointer"
        ...
        >
          ...
          <div className="pl-3">
            ...
            <p className="text-xs leading-3 pt-1 text-gray-500">Jim: fine.</p>
          </div>
        </div>
      </div>
    </section>
