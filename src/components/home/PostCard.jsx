                                        ...
                                        <Menu.Item key={index}>
                                            {({ active }) => (
                                                <button className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700 w-full')}>
                                                    ...
                                                    {
                                                        option.toLowerCase() === "copy link" ? <LinkIcon className='h-4 w-4 flex float-left mr-3 stroke-1 stroke-indigo-800' /> : null
                                                    }
                                                    {
                                                        option.toLowerCase() === "unfollow" ? <XCircleIcon className='h-4 w-4 flex float-left mr-3 stroke-1 stroke-indigo-800' /> : null
                                                    }
