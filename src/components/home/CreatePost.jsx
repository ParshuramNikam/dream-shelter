...
import { ChatIcon, NewspaperIcon, PhotographIcon, VideoCameraIcon } from "@heroicons/react/outline";
    ...
    <section className="w-100 hidden lg:block  px-3 py-5 m-2 bg-white border border-gray-200 rounded-lg overflow-hidden shadow-lg">
      <div className="flex gap-3 relative items-center ">
        <img
          ...
          alt=""
        />
        <div className="grow w-full bg-gray-200 text-gray-600 rounded-lg h-10 px-3 py-2.5 cursor-pointer"
          onClick={openModal}
        >
          Ask a Question...
        </div>
